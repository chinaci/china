$(function(){
	...
	$(".header .s-type li").click(function(){
		...
		t.closest('form').attr('action', t.closest('form').data("action" + type));
    ...
    $.ajax({
      ...
      //显示区号
      $('.m-form .areaCode').bind('click', function(){

        var areaWrap =$(this).closest(".m-form").find('.areaCode_wrap');
      ...
      //选择区号
      $('.m-form .areaCode_wrap').delegate('li', 'click', function(){
        var t = $(this), code = t.attr('data-code');
        var par = t.closest(".m-form");
