...
$(function(){
	...
	if(getParam('state')){
		$(".order_nav ul li[data-id='"+getParam('state')+"']").click()
	}
    ...
    function getList(item) {
        ...
        $.ajax({
            url: masterDomain+"/include/ajax.php?service=travel&action=orderList&state="+state+"&page="+atpage+"&pageSize="+pageSize,
            type: "GET",
            dataType: "jsonp",
            success: function (data) {
