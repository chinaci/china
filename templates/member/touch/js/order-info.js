...
function getList(is){
    ...
    $.ajax({
        url: masterDomain+"/include/ajax.php?service=info&action=orderList&state="+state+"&page="+atpage+"&pageSize="+pageSize,
        type: "GET",
        dataType: "jsonp",
        success: function (data) {
                        ...
                        for(var i = 0; i < list.length; i++){
                            ...
                            switch(orderstate){
                                case "0":
                                    ...
                                    btn = '<a href="javascript:;" class="btn-nobg del">'+langData['siteConfig'][6][65]+'</a><a href="'+payurl+'" class="sureBtn btn-bg">'+langData['siteConfig'][6][64]+'</a>';
                                    break;
                                case "1":
                                    stateInfo = '<p class="order-state"><span>'+langData['siteConfig'][9][25]+'</span></p>';
                                    btn = '<a href="'+refundlUrl+'" class="sureBtn btn-bg">'+langData['siteConfig'][6][66]+'</a>';
                                    break;
                                case "3":
									//申请退款
									if(retState == 1){
                                    ...
                                    // stateInfo = '<p class="order-state"><span>'+langData['siteConfig'][9][26]+'</span></p>';
                                    // btn = '<a href="'+detailUrl+'" class="btn-bg sh">'+langData['siteConfig'][6][45]+'</a>';
                                    break;
                                case "4":
                                ...
                                case "7":
                                    ...
                                    break;
                                case "10":
                                    stateInfo = '<p class="order-state"><span>'+langData['siteConfig'][6][15]+'</span></p>';
                                    break;
                            }

							html.push('<dl class="myitem" data-id="'+list[i].id+'">');
							html.push('<dt><p class="shop_name"><i></i><span>'+store.title+'</span></p><p class="order-state"><span>'+stateInfo+'</span></p></dt>');
