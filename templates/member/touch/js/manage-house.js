    			...
    			if(data.state == 101){
                    ...
                    bid_price   = list[i].bid_price,
    						...
    						if(type == "qzu" || type == "qgou"){
    							...
    							html.push('<h5><a href="javascript:;" title="'+title+'">'+title+'</a></h5>');
    							html.push('</div>');
    							html.push('</div>');
                  ...
                  var p = lei == 0 ? echoCurrency('short')+"/"+echoCurrency('areasymbol')+"•"+langData['siteConfig'][13][18] : langData['siteConfig'][13][27]+echoCurrency('short');//月 -- 万
