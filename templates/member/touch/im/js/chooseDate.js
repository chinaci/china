(function($) {
    $.fn.mdater = function(config) {
        ...
        var input = this;
		var max_year = option.maxDate.getFullYear(),min_year = option.minDate.getFullYear();
        ...
        var F = {
            ...
            getMonth: function(m) {
                return [langData['siteConfig'][30][61], langData['siteConfig'][30][62], langData['siteConfig'][30][63], langData['siteConfig'][30][64], langData['siteConfig'][30][65], langData['siteConfig'][30][66], langData['siteConfig'][46][95], langData['siteConfig'][46][96], langData['siteConfig'][46][97], langData['siteConfig'][46][98], langData['siteConfig'][46][99], langData['siteConfig'][46][100]][m];//一 到 十二
            },
            //计算年某月的最后一天日期
        ...
        var mdater = {
            ...
            renderHTML: function() {
                var $html = $('<div class="md_mask"></div><div class="md_panel"><div class="md_head"><div class="md_selectarea"><a class="md_prev change_year" href="javascript:void(0);"></a><a class="md_headtext yeartag" href="javascript:void(0);"></a><a class="md_next change_year" href="javascript:void(0);"></a></div><div class="md_selectarea"><a class="md_prev change_month" href="javascript:void(0);"></a><a class="md_headtext monthtag" href="javascript:void(0);">'+langData['siteConfig'][13][18]+'</a> <a class="md_next change_month" href="javascript:void(0);"></a></div></div><div class="md_body"><ul class="md_weekarea"><li>'+langData['siteConfig'][13][25]+'</li><li>'+langData['siteConfig'][30][61]+'</li><li>'+langData['siteConfig'][30][62]+'</li><li>'+langData['siteConfig'][30][63]+'</li><li>'+langData['siteConfig'][30][64]+'</li><li>'+langData['siteConfig'][30][65]+'</li><li>'+langData['siteConfig'][30][66]+'</li></ul><ul class="md_datearea in"></ul></div><div class="md_foot"><a href="javascript:void(0);" class="md_ok">'+langData['siteConfig'][6][1]+'</a> <a href="javascript:void(0);" class="md_cancel">'+langData['siteConfig'][6][12]+'</a></div></div>');//月--日--一--二--三--四--五--六--确定--取消
            ...
            _changeMonth: function(add, checkDate) {
                ...
                var nextMonth = F.getMonth(num) + langData['siteConfig'][13][18];//月
            ...
            _changeYear: function(add) {
                ...
                yearTag.text(num + langData['siteConfig'][13][14]).data('year', num);//年
                this.value.year = num;
            ...
            getDateStr: function(y, m, d) {
                ...
                for (var j = startDay; j <= endDay; j++) {
                    ...
                    if(option.disableDate){
						for(var a=0;a<option.disableDate.length;a++){
							var year = option.disableDate[a].getFullYear(),
							mon=option.disableDate[a].getMonth(),
							day = option.disableDate[a].getDate();
							if(year==this.value.year && mon==this.value.month && day==j){
								current = 'disabled';
							}
						}
					}
