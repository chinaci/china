	...
	objId.delegate(".del", "click", function(){
		...
		if(id){
			$.dialog.confirm(langData['siteConfig'][20][211], function(){
				...
				$.ajax({
					url: masterDomain+"/include/ajax.php?service=business&action=delabout&id="+id,
					type: "GET",
					dataType: "jsonp",
...
function getList(is){
	...
	$.ajax({
		url: masterDomain+"/include/ajax.php?service=business&action=about&u=1&page="+atpage+"&pageSize="+pageSize,
		type: "GET",
		dataType: "jsonp",
		success: function (data) {
