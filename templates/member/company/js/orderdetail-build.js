$(function(){
	...
	$("#expBtn").bind("click", function(){
		...
		$.ajax({
			url: "/include/ajax.php?service=build&action=delivery",
			data: data.join("&"),
			type: "POST",
			dataType: "json",
	...
	$(".tuikuan").bind("click", function(){
		...
		$.dialog.confirm(langData['siteConfig'][20][407], function(){
			...
			$.ajax({
				url: "/include/ajax.php?service=build&action=refundPay",
				data: "id="+detailID,
				type: "POST",
				dataType: "json",
				success: function (data) {
	...
	$("#hfBtn").bind("click", function(){
		...
		$.ajax({
			url: masterDomain+"/include/ajax.php?service=build&action=refundReply",
			data: data,
			type: "POST",
			dataType: "jsonp",
			success: function (data) {
