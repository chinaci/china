$(function(){
	...
	$("#expBtn").bind("click", function(){
		...
		$.ajax({
			url: "/include/ajax.php?service=furniture&action=delivery",
			data: data.join("&"),
			type: "POST",
			dataType: "json",
	...
	$(".tuikuan").bind("click", function(){
		...
		$.dialog.confirm(langData['siteConfig'][20][407], function(){
			...
			$.ajax({
				url: "/include/ajax.php?service=furniture&action=refundPay",
				data: "id="+detailID,
				type: "POST",
				dataType: "json",
				success: function (data) {
	...
	if($list.length > 0){
		...
		uploader = WebUploader.create({
			...
			server: '/include/upload.inc.php?mod=furniture&type=atlas',
			pick: '#filePicker',
			fileVal: 'Filedata',
			accept: {
				title: 'Images',
	...
	$("#hfBtn").bind("click", function(){
		...
		$.ajax({
			url: masterDomain+"/include/ajax.php?service=furniture&action=refundReply",
			data: data,
			type: "POST",
			dataType: "jsonp",
			success: function (data) {
