...
function getList(is){
	...
	var url ="/include/ajax.php?service=renovation&action=diary&u=1&company="+Identity.store.id+"&orderby=1&state="+state+"&page="+atpage +"&pageSize="+pageSize;
	$(".pagination").hide();
                  ...
                  totalCount = pageInfo.totalCount;
					...
					if(list.length > 0){
						...
						for(var i = 0; i < list.length; i++){
							...
							html.push('<p>'+area+echoCurrency('areasymbol')+'&nbsp;&nbsp;·&nbsp;&nbsp;'+style+'&nbsp;&nbsp;·&nbsp;&nbsp;'+price+'&nbsp;&nbsp;·&nbsp;&nbsp;'+btype+langData['siteConfig'][19][394]+'：'+click+langData['siteConfig'][13][26]+'</p>');
							html.push('</div>');
							html.push('</div>');
