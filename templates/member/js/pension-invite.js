				...
				if(data.state == 101){
					...
					if(list.length > 0){
						for(var i = 0; i < list.length; i++){
							...
							html.push('<table data-id="'+id+'" class="oh"> <colgroup> <col style="width:5%;"> <col style="width:40%;"> <col style="width:15%;"> <col style="width:15%;"> <col style="width:15%;"> <col style="width:25%;"> </colgroup> <thead> <th></th> <th class="tl">'+langData['siteConfig'][38][96]+'</th> <th>'+langData['siteConfig'][19][642]+'</th> <th>'+langData['siteConfig'][38][97]+'</th>  <th>'+langData['siteConfig'][6][11]+'</th> </thead> <tbody>');
							//邀请机构--联系人--邀请日期--操作
