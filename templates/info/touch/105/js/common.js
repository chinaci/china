...
$(function(){
    ...
    // 列表
    $('.recomShop ul li,.homelist ul li').bind('touchstart', function() {
       $(this).addClass('bColor');
    });
    $('.recomShop ul li,.homelist ul li').bind('touchend', function() {
       $(this).removeClass('bColor');
    });
    // 电话弹框
    $('.recomShop').delegate('.tel', 'click', function(event) {
    	...
    	var code_ = t.attr("data-code");
    	$(".modal-main .fn-clear b").html(code_);
