$(function(){
  ...
  $(".news-slide").slide( { mainCell:".bd ul",autoPlay:true,effect:"topMarquee",vis:3,interTime:50,trigger:"click",mouseOverStop:true  });
  $(".adv-slide-1").slide( { mainCell:".bd ul",autoPlay:true,vis:3,effect:"leftLoop", trigger:"click"});
  $(".adv-slide-2").slide( { mainCell:".bd ul",autoPlay:true,vis:3,effect:"leftLoop", trigger:"click"});
  $(".adv-slide-3").slide( { mainCell:".bd ul",autoPlay:true,vis:3,effect:"leftLoop", trigger:"click"});
  ...
  // 表单验证
  var djObj = $('.content-right'),info = djObj.find('.info');
  ...
  djObj.find('.price').focus(function(){
    ...
    $('.content-right form').submit(function(e){
        if(validation.loupan(1) && validation.price(1) && validation.name(1) && validation.phone(1)) {
            ...
            data.push("note="+djObj.find('textarea').val());
