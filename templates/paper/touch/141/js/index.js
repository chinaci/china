                ...
                if(data.state == 100){
                    ...
                    for(var i=0;i<datalist.length;i++){
                        if(datalist[i].forum){
                            if(n%2 == 0){
                                list = `
                                  <li class="item"><a href="`+datalist[i].forum.url+`">
                                    <div class="img-box"><img src="`+datalist[i].forum.litpic+`" alt=""></div>
                                    <div class="info">
                                        <p class="name">`+datalist[i].title+`</p>
                                        <p class="time">`+datalist[i].forum.date+`</p>
                                    </div>
                                </a></li>
                            `;
