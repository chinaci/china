...
var m = Math,
	...
	iScroll = function (el, options) {
		...
		that.options = {
			...
			y: 0,
			bounce: true,
			bounceLock: false,//momentum
			momentum: true,
			lockDirection: true,
			useTransform:true,//true
			useTransition: false,
			topOffset: 0,
			...
			// Events
			onRefresh: null,
			onBeforeScrollStart:function(e){e.preventDefault();},//e.preventDefault(); },//null//function(e){e.preventDefault();}
			onScrollStart: null,
			onBeforeScrollMove:function(e){e.preventDefault();},//function(e){e.preventDefault();}
			onScrollMove: null,
