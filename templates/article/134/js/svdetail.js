$(function(){
    ...
    $('.shoucang').bind('click',function () {
        ...
        $.post("/include/ajax.php?service=member&action=collect&module=article&temp=detail&id="+aid+"&type="+type);
    });
...
//关注
    ...
    $(".zan").bind("click", function(){
        ...
        $.post("/include/ajax.php?service=member&action=getZan&module=article&temp=detail&id="+aid+"&uid="+admin);
