$(function(){
    ...
    $('.wcmt_send, .submit_top').click(function(){
		...
		var contentObj = t.hasClass("submit_top") ? $(".newcomment") : $(".newcomment"), content = $(".newcomment").val();console.log(content);
    ...
    function getComment(tr){
        ...
        $(".commentList ul").append('<div class="loading"><img src="'+templets_skin+'images/loading.png" alt=""></div>');
        ...
        $.ajax({
          ...
          success: function(data){
              if(data && data.state == 100){
                  ...
                  isload = true;
                  $(".loading").remove();
                  $(".commentList ul").append('<div class="loading"><span>'+data.info+'</span></div>');
              }
          },
