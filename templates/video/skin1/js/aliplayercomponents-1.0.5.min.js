! function(A) {
	...
	e.m = A, e.c = t, e.d = function(A, t, n) {
		...
		if (e.r(n), Object.defineProperty(n, "default", {
			...
			for (var i in A) e.d(n, i, function(t) {
				return A[t]
			}.bind(null, i));
		return n
	}, e.n = function(A) {
	...
	A.exports = function(A) {
		...
		return t.toString = function() {
			return this.map(function(t) {
				var e = function(A, t) {
					...
					if (t && "function" == typeof btoa) {
						var o = (e = i, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(
			...
			for (i = 0; i < A.length; i++) {
				var r = A[i];
				"number" == typeof r[0] && n[r[0]] || (e && !r[2] ? r[2] = e : e && (r[2] = "(" + r[2] + ") and (" + e + ")"),
					t.push(r))
			}
		}, t
	}
	...
	function h(A, t) {
		...
		var n = c[c.length - 1];
		if ("top" === A.insertAt) n ? n.nextSibling ? e.insertBefore(t, n.nextSibling) : e.appendChild(t) : e.insertBefore(
			t, e.firstChild), c.push(t);
		else if ("bottom" === A.insertAt) e.appendChild(t);
		else {
			if ("object" != typeof A.insertAt || !A.insertAt.before) throw new Error(
	...
	function f(A, t) {
		...
		} else A.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL
			.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (e = function(A) {
				var t = document.createElement("link");
				return void 0 === A.attrs.type && (A.attrs.type = "text/css"), A.attrs.rel = "stylesheet", g(t, A.attrs), h(A, t),
					t
			}(t), n = function(A, t, e) {
				var n = e.css,
					i = e.sourceMap,
	...
	A.exports = function(A, t) {
		...
		(t = t || {}).attrs = "object" == typeof t.attrs ? t.attrs : {}, t.singleton || "boolean" == typeof t.singleton ||
			(t.singleton = r()), t.insertInto || (t.insertInto = "head"), t.insertAt || (t.insertAt = "bottom");
		var e = p(A, t);
		return u(e, t),
			function(A) {
	...
	var e = function() {
			var A = {
				bsearch: function(A, t, e) {
					...
					for (var n = 0, i = 0, o = 0, r = A.length - 1; n <= r;) {
						...
						e(t, A[i - 1]) < 0 ? r = i - 1 : e(t, A[i]) >= 0 ? n = i : console.error("Program Error"), o > 1500 &&
		...
		i = function() {
			...
			return A.prototype.willCollide = function(A, t) {
				...
				A.height > this._height ? (A.cindex = -2, A.y = 0) : (A.y = this.assign(A, 0), e.binsert(this._pools[A.cindex],
					A,
					function(A, t) {
		...
		r = (n = this && this.__extends || function(A, t) {
			for (var e in t) t.hasOwnProperty(e) && (A[e] = t[e]);
			...
			function A(t, e) {
				if (void 0 === e && (e = {}), this.mode = 1, this.stime = 0, this.text = "", this.ttl = 4e3, this.dur = 4e3,
					this.cindex = -1, this.motion = [], this.movable = !0, this._alphaMotion = null, this.absolute = !0, this.align =
					0, this._alpha = 1, this._size = 25, this._color = 16777215, this._border = !1, this._shadow = !0, this._font =
					"", !t) throw new Error("Comment not bound to comment manager.");
				if (this.parent = t, e.hasOwnProperty("stime") && (this.stime = e.stime), e.hasOwnProperty("mode") ? this.mode =
					e.mode : this.mode = 1, e.hasOwnProperty("dur") && (this.dur = e.dur, this.ttl = this.dur), this.dur *= this.parent
					.options.global.scale, this.ttl *= this.parent.options.global.scale, e.hasOwnProperty("text") && (this.text = e
						.text), e.hasOwnProperty("motion")) {
				...
				e.hasOwnProperty("color") && (this._color = e.color), e.hasOwnProperty("size") && (this._size = e.size), e.hasOwnProperty(
					"border") && (this._border = e.border), e.hasOwnProperty("opacity") && (this._alpha = e.opacity), e.hasOwnProperty(
					"alpha") && (this._alphaMotion = e.alpha), e.hasOwnProperty("font") && (this._font = e.font), e.hasOwnProperty(
					"x") && (this._x = e.x), e.hasOwnProperty("y") && (this._y = e.y), e.hasOwnProperty("shadow") && (this._shadow =
					e.shadow), e.hasOwnProperty("position") && "relative" === e.position && (this.absolute = !1, this.mode < 7 &&
					console.warn("Using relative position for CSA comment."))
			}
			return A.prototype.init = function(A) {
				void 0 === A && (A = null), this.dom = null !== A ? A.dom : document.createElement("div"), this.dom.className =
					this.parent.options.global.className, this.dom.appendChild(document.createTextNode(this.text)), this.dom.textContent =
					this.text, this.dom.innerText = this.text, this.size = this._size, 16777215 != this._color && (this.color =
						this._color), this.shadow = this._shadow, this._border && (this.border = this._border), "" !== this._font &&
					(this.font = this._font), void 0 !== this._x && (this.x = this._x), void 0 !== this._y && (this.y = this._y),
					(1 !== this._alpha || this.parent.options.global.opacity < 1) && (this.alpha = this._alpha), this.motion.length >
					0 && this.animate()
			}, Object.defineProperty(A.prototype, "x", {
				get: function() {
					return null !== this._x && void 0 !== this._x || (this.align % 2 == 0 ? this._x = this.dom.offsetLeft : this
							._x = this.parent.width - this.dom.offsetLeft - this.width), this.absolute ? this._x : this._x / this.parent
						.width
				},
				set: function(A) {
					this._x = A, this.absolute || (this._x *= this.parent.width), this.align % 2 == 0 ? this.dom.style.left =
						this._x + "px" : this.dom.style.right = this._x + "px"
				},
				enumerable: !0,
				configurable: !0
			}), Object.defineProperty(A.prototype, "y", {
				get: function() {
					return null !== this._y && void 0 !== this._y || (this.align < 2 ? this._y = this.dom.offsetTop : this._y =
						this.parent.height - this.dom.offsetTop - this.height), this.absolute ? this._y : this._y / this.parent.height
				},
				set: function(A) {
					this._y = A, this.absolute || (this._y *= this.parent.height), this.align < 2 ? this.dom.style.top = this._y +
						"px" : this.dom.style.bottom = this._y + "px"
				},
				enumerable: !0,
				configurable: !0
				...
				set: function(A) {
					this._color = A;
					var t = A.toString(16);
					t = t.length >= 6 ? t : new Array(6 - t.length + 1).join("0") + t, this.dom.style.color = "#" + t, 0 ===
						this._color && (this.dom.className = this.parent.options.global.className + " rshadow")
				},
				enumerable: !0,
				configurable: !0
				...
				set: function(A) {
					this._border = A, this._border ? this.dom.style.border = "1px solid #00ffff" : this.dom.style.border =
						"none"
				},
				enumerable: !0,
				configurable: !0
				...
				if (this._alphaMotion && (this.alpha = (this.dur - this.ttl) * (this._alphaMotion.to - this._alphaMotion.from) /
						this.dur + this._alphaMotion.from), 0 !== this.motion.length) {
					var A = Math.max(this.ttl, 0),
						t = this.dur - A - this._motionStart[this._curMotion];
					return this._execMotion(this.motion[this._curMotion], t), this.dur - A > this._motionEnd[this._curMotion] ? (
						this._curMotion++, void(this._curMotion >= this.motion.length && (this._curMotion = this.motion.length - 1))
					) : void 0
				}
		...
		a = function(A) {
			...
			return n(t, A), Object.defineProperty(t.prototype, "alpha", {
				set: function(A) {
					this._alpha = A, this.dom.style.opacity = Math.min(Math.min(this._alpha, this.parent.options.global.opacity),
						this.parent.options.scroll.opacity) + ""
				},
				enumerable: !0,
				configurable: !0
			}), t.prototype.init = function(t) {
				void 0 === t && (t = null), A.prototype.init.call(this, t), this.x = this.parent.width, this.parent.options.scroll
					.opacity < 1 && (this.alpha = this._alpha), this.absolute = !0
	...
	! function() {
		var A = function(A, t) {
			for (var e = Math.PI / 180, n = A * e, i = t * e, o = Math.cos, r = Math.sin, a = [o(n) * o(i), o(n) * r(i), r(n),
					0, -r(i), o(i), 0, 0, -r(n) * o(i), -r(n) * r(i), o(n), 0, 0, 0, 0, 1
				], l = 0; l < a.length; l++) Math.abs(a[l]) < 1e-6 && (a[l] = 0);
		...
		t.prototype.stop = function() {
			...
			this.timeline = A, this.timeline.sort(function(A, t) {
				return A.stime > t.stime ? 2 : A.stime < t.stime ? -2 : A.date > t.date ? 1 : A.date < t.date ? -1 : null != A
					.dbid && null != t.dbid ? A.dbid > t.dbid ? 1 : A.dbid < t.dbid ? -1 : 0 : 0
			...
			for (var A in this.width = this.stage.offsetWidth, this.height = this.stage.offsetHeight, this.dispatchEvent(
					"resize"), this.csa) this.csa[A].setBounds(this.width, this.height);
			this.stage.style.perspective = this.width * Math.tan(40 * Math.PI / 180) / 2 + "px", this.stage.style.webkitPerspective =
			...
			for (; this.position < this.timeline.length && this.timeline[this.position].stime <= A; this.position++) this.options
				.limit > 0 && this.runline.length > this.limiter || this.validate(this.timeline[this.position]) && this.send(
					this.timeline[this.position])
			...
			if (8 !== t.mode) {
				if (null == this.filter || null != (t = this.filter.doModify(t))) {
					...
					switch (e.init(), this.stage.appendChild(e.dom), e.mode) {
						...
						case 17:
						case 7:
							0 === t.rY && 0 === t.rZ || (e.dom.style.transform = A(t.rY, t.rZ), e.dom.style.webkitTransform = A(t.rY, t.rZ),
								e.dom.style.OTransform = A(t.rY, t.rZ), e.dom.style.MozTransform = A(t.rY, t.rZ), e.dom.style.MSTransform =
								A(t.rY, t.rZ))
					}
			...
			if (void 0 !== this._listeners[A])
				for (var e = 0; e < this._listeners[A].length; e++) try {
	...
	A.exports = function(A) {
		...
		return A.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(A, t) {
			...
			return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(o) ? A : (i = 0 === o.indexOf("//") ? o : 0 ===
				o.indexOf("/") ? e + o : n + o.replace(/^\.\//, ""), "url(" + JSON.stringify(i) + ")")
		})
	}
}, function(A, t, e) {
	var n = e(34);
	...
	(A.exports = e(0)(!1)).push([A.i, '@font-face {\n  font-family: "iconfont";\n  src: url(' + n(e(4)) +
		...
		n(e(68)) + ') format("truetype"), url(' + n(e(69)) +
		'#iconfont) format("svg");\n  /* iOS 4.1- */ }\n\n.iconfont {\n  font-family: "iconfont" !important;\n  font-size: 16px;\n  font-style: normal;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale; }\n\n.icon-list:before {\n  content: "\\E643"; }\n\n.icon-skipnext:before {\n  content: "\\EA9E"; }\n\n.icon-skip-previous:before {\n  content: "\\E6D3"; }\n\n.icon-close:before {\n  content: "\\E616"; }\n\n.icon-player-rotate-left:before {\n  content: "\\E658"; }\n\n.icon-player-rotate-right:before {\n  content: "\\E659"; }\n\n.icon-player-switch:before {\n  content: "\\E781"; }\n\n.icon-danmu-close:before {\n  content: "\\E696"; }\n\n.icon-danmu-open:before {\n  content: "\\E697"; }\n\n.icon-player-play:before {\n  content: "\\E641"; }\n',
		""
	])
}, function(A, t) {
	A.exports =
		"data:font/ttf;base64,"
}, function(A, t) {
	A.exports =
	...
	var u = function() {
		...
		p = function() {
			function A(t) {
				...
				}(this, A), this.sendEl = e, this.danmukuList = t, this.html = c(i.a), this.danmuControlHtml = c(r.a), this.sendEl =
					e, this.danmuInput = null === e ? null : c(l.a), this.CM = null, this.userDanmuOpen = !0
			}
			return u(A, [{
				key: "createEl",
				value: function(A, t) {
					...
					if (this.isEn = n && "en-us" === n, null !== this.danmuInput && (this.danmuInput.querySelector(
							".danmu-input-enter").innerText = this.isEn ? "Enter" : "发送", this.danmuInput.querySelector("input").setAttribute(
							"placeholder", this.isEn ? "Input danmu" : "输入弹幕")), this.danmuControlHtml.querySelector(
							".player-tooltip.close").innerText = this.isEn ? "Close Bullect" : "关闭弹幕", this.danmuControlHtml.querySelector(
							".player-tooltip.open").innerText = this.isEn ? "Open Bullect" : "打开弹幕", "controlbar" === this.sendEl) {
					...
					r ? A.insertBefore(this.html, r) : A.appendChild(this.html), this.CM = new s.CommentManager(this.html.querySelector(
							".danmu")), this.CM.init(), this.CM.load(this.danmukuList), A.querySelector("video").ontimeupdate =
						function() {
					...
					if (a.onclick = function() {
						...
						this.danmuInput.querySelector(".danmu-input-enter").onclick = this.sendDanmuHandle.bind(this), c.onkeydown =
							function(A) {
		...
		g = function() {
			...
			return m(A, [{
				...
				value: function(A, t) {
					var e = this;
					A.getOptions(), !1 === A.getOptions().autoplay && (this.html.style.animationPlayState = "paused"), Object.keys(
						this.style).forEach(function(A) {
				...
				value: function(A, t) {
					...
					if (n) {
						...
						var i = getComputedStyle(n),
							...
							l = this.text,
							s = n.innerText;
						"none" === o && n.style.setProperty("display", "block"), "1" !== r && n.style.setProperty("opacity", "1"),
							"hidden" === a && n.style.setProperty("visibility", "visible"), l != s && (n.innerText = l)
		...
		x = function() {
			function A() {
				...
				! function(A, t) {
					if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function")
				}(this, A), this.html = c(v.a), this.autoPlay = t, this.getTime = e || this._getTime, this.saveTimeFunction = n ||
					this._saveTime, this.hasMemoryDisplay = !1
			}
			return M(A, [{
				key: "createEl",
				value: function(A) {
		...
		I = function() {
			...
			return w(A, [{
				...
				value: function(A, t) {
					...
					i.setAttribute("href", this.adUrl), o.setAttribute("src", this.coverUrl), this.html.querySelector(
		...
		C = function() {
			function A(t) {
				! function(A, t) {
					if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function")
				}(this, A), this.controlHtml = c(D.a), this.listHtml = c(Q.a), this.playlist = t, this.playingVideoIndex = 0,
			...
			return B(A, [{
				...
				value: function(A, t) {
					var e = this,
						n = t._options && t._options.language;
					this.isEn = n && "en-us" === n, this.controlHtml.querySelector(".player-tooltip.prev").innerText = this.isEn ?
						"Previous" : "上一个", this.controlHtml.querySelector(".player-tooltip.list").innerText = this.isEn ?
						"Playlist" : "播放列表", this.controlHtml.querySelector(".player-tooltip.next").innerText = this.isEn ? "Next" :
						"下一个";
					...
					i.insertBefore(this.controlHtml, o), this.listHtml.onmouseleave = function() {
						...
						}, this.listHtml.onmouseenter = this.clearHideListTimeout.bind(this), this.controlHtml.querySelector(
							".icon-list").onclick = this.tooglePlaylist.bind(this), this.listHtml.querySelector(".list").innerHTML =
						this.computedListDom(this.playlist);
					var r = t.getOptions() && t.getOptions().source,
						a = 0;
					r && (a = (a = this.playlist.findIndex(function(A) {
						return A.source === r
					})) > -1 ? a : 0, this.playingVideoIndex = a > -1 ? a : 0), this.listHtml.querySelector(".list").childNodes[
						0].className = "video-item active", A.appendChild(this.listHtml)
				}
			}, {
				key: "ready",
				value: function(A, t) {
					...
					this.controlHtml.querySelector(".icon-skip-previous").onclick = function() {
						0 !== e.playingVideoIndex ? e.playVideo(A, e.playingVideoIndex - 1) : e.playlistTip(e.isEn ?
							"Already the first one~" : "已经是第一个了~", A._el)
					}, this.controlHtml.querySelector(".icon-skipnext").onclick = function() {
						e.playingVideoIndex !== e.playlist.length - 1 ? e.playVideo(A, e.playingVideoIndex + 1) : e.playlistTip(e.isEn ?
							"Already the last one~" : "已经是最后一个了~", A._el)
				...
				key: "playVideo",
				value: function(A, t) {
					this.playingVideoIndex !== t && (this.playingVideoIndex = parseInt(t), A.loadByUrl(this.playlist[t].source),
						this.listHtml.querySelector(".video-item.active").className = "video-item", this.listHtml.querySelector(
							".list").childNodes[t].className = "video-item active")
				}
			}, {
				key: "tooglePlaylist",
				value: function() {
					var A = this;
					this.clearHideListTimeout(), "30%" === this.listHtml.style.width ? this.listHtml.style.width = 0 : (this.listHtml
						.style.width = "30%", this.listHideTimeout = setTimeout(function() {
		...
		S = function() {
			function A(t) {
				...
				! function(A, t) {
					if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function")
				}(this, A), this.previewDuration = t, this.html = c(j.a), null !== e && this.insertHTtml(e, "previewEndHtml"),
					null !== n && this.insertHTtml(n, "previewBarHtml")
			}
			return L(A, [{
				key: "play",
				value: function(A) {
					this.previewEnd && (A._el.querySelector(".center").classList.remove("preview-hide"), A.seek(0), this.previewEnd = !
						1)
				}
			}, {
				key: "insertHTtml",
				value: function(A, t) {
					...
					if ("string" == typeof A)
						if ("#" === A[0]) {
							...
							i ? n.innerHTML = i.innerHTML : console.warn("[aliplayer components warn]: Invalid parameter " + t +
								", can't find element by this id")
						} else n.innerHTML = A;
					else console.warn("[aliplayer components warn]: Invalid parameter " + t + ", " + t +
				...
				value: function(A) {
					...
					this.videoDuration = t, !this.invalidPreview && this.previewDuration >= t && (this.invalidPreview = !0,
						console.warn(
				...
				value: function(A, t) {
					...
					i && (i.innerText = this.isEn ? "Preview is over" : "试看已结束"), this.html.querySelector(".can-preview").innerText =
						this.isEn ? "Try" : "可试看";
					var o = this.previewDuration;
					0 === o && (this.html.style.display = "none");
					var r = o / 60,
						a = r.toString().split(".")[1];
					r = a && a.length > 1 ? " " + o + (this.isEn ? " senconds" : " 秒") : " " + r + (this.isEn ? " minutes" :
						" 分钟"), o < 60 && (r = " " + o + (this.isEn ? " senconds" : " 秒")), this.html.querySelector(
						".preview-time").innerText = r;
					var l = A.querySelector("video").nextElementSibling;
					l ? A.insertBefore(this.html, l) : A.appendChild(this.html), this.html.querySelector(".preview-vod-close").addEventListener(
						"click",
						function() {
				...
				value: function(A) {
					if (!this.previewEnd && 0 !== this.previewDuration && this.previewDuration < this.videoDuration) {
						var t = A.getPreviewTime(),
							e = A.getCurrentTime();
						Math.floor(t) < e && (this.previewEnd = !0, A._el.querySelector(".center").classList.add("preview-hide"), A
							.seek(t), A.pause(), this.html.querySelector(".preview-component-layer").style.display = "block")
					}
				}
			}, {
				key: "ended",
		...
		U = function() {
			function A() {
				! function(A, t) {
					if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function")
				}(this, A), this.html = c(O.a), this.imgEle = this.html.querySelector(".img-wrap img"), this.timeEle = this.html.querySelector(
					".time"), this.playBtnEle = this.html.querySelector(".pregress-play-btn"), this.describeEle = this.html.querySelector(
					".describe"), this.timer = null, this.currentOffset = null
			}
			return Y(A, [{
				key: "createEl",
				value: function(A, t) {
				...
				value: function(A, t) {
					...
					e * t.left + 323 > e ? (n = e - 330 + "px", this.html.querySelector(".icon-arrowdown").style.left = e * t.left -
						e + 317 + "px") : this.html.querySelector(".icon-arrowdown").style.left = "-2px";
					var i = t.progressMarker,
						o = i.coverUrl,
						r = i.title,
						a = i.describe,
						l = i.offset;
					this.currentOffset = l, this.html.style.left = n, this.imgEle.src = o, this.timeEle.innerText = r, this.describeEle
						.innerText = a, this.html.style.display = "block"
				}
			}, {
				key: "markerDotOut",
				value: function(A, t) {
		...
		q = function() {
			function A(t) {
				! function(A, t) {
					if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function")
				}(this, A), this.html = c(F.a), this.modalHtml = c(Z.a), this.hasCreated = !1, this.definition = "", this.getQuality =
					t
			}
			return V(A, [{
				key: "createEl",
				value: function(A, t) {
					...
					this.isEn = e && "en-us" === e, this.html.querySelector(".current-quality").innerText = this.isEn ?
						"Resolution" : "清晰度", this.modalHtml.querySelector(".switchimg").innerText = this.isEn ?
						"Switching to you for" : "正在为您切换到", this.modalHtml.querySelector(".wait").innerText = this.isEn ?
						"Please wait..." : "请稍后...", A.querySelector(".prism-controlbar").appendChild(this.html), A.appendChild(
							this.modalHtml)
				}
			}, {
				...
				value: function(A) {
					...
					this.html.querySelector(".quality-list").innerHTML = i.join(""), this.definition, 0 == this.hasCreated &&
					...
					e.onclick = function() {
						...
						if (i && "current" !== n.className) {
							...
							A.loadByUrl(r.Url, A.getCurrentTime(), !0, !0), t.setCurrentQuality(r.desc, r.definition), t.modalHtml.style
								.display = "block", t.modalHtml.querySelector("span.current-quality-tag").innerText = r.desc
						}
						t.getQuality(i, o)
					}
				}
		...
		$ = function() {
			...
			return _(A, [{
				...
				value: function(A, t) {
					var e = t._options && t._options.language;
					this.isEn = e && "en-us" === e, this.html.querySelector(".player-tooltip.counterclockwise").innerText = this
						.isEn ? "Rotate 45 degrees counterclockwise" : "逆时针旋转45度", this.html.querySelector(
							'.mirror-item[data-id="counterclockwise"]').innerText = this.isEn ? "Rotate left 45 ̊" : "左旋转45˚", this.html
						.querySelector(".player-tooltip.clockwise").innerText = this.isEn ? "Rotate 45 degrees clockwise" :
						"顺时针旋转45度", this.html.querySelector('.mirror-item[data-id="clockwise"]').innerText = this.isEn ?
						"Rotate right 45 ̊" : "右旋转45˚", this.html.querySelector(".player-tooltip.switch").innerText = this.isEn ?
						"Mirror" : "镜像", this.html.querySelector(".mirror-item[data-id=vertical]").innerText = this.isEn ?
						"Vertical mirroring" : "垂直镜像", this.html.querySelector(".mirror-item[data-id=horizon]").innerText = this.isEn ?
						"Horizontal mirroring" : "水平镜像", A.querySelector(".prism-controlbar").appendChild(this.html)
				}
			}, {
				key: "ready",
				value: function(A, t) {
		...
		nA = function() {
			function A(t, e, n) {
				if (function(A, t) {
						if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function")
					}(this, A), this.coverUrl = t, this.adUrl = e, this.adDuration = n, n <= 0) throw Error(
					"adDuration must must be greater than 0");
				this.html = c(tA.a)
			}
			return eA(A, [{
				key: "createEl",
				value: function(A, t) {
					var e = this,
						n = t._options && t._options.language;
					this.isEn = n && "en-us" === n, this.html.querySelector(".ad-name").innerText = this.isEn ? "Ad" : "广告",
						this.html.querySelector(".second").innerText = this.isEn ? "s" : "秒";
					var i = this.html.querySelector(".ad-content");
					if (i.setAttribute("href", this.adUrl), i.querySelector("img").setAttribute("src", this.coverUrl), this.html
						.querySelector(".tip i").innerText = this.adDuration, A.appendChild(this.html), null !== this.html) {
		...
		sA = "function" == typeof Symbol && "symbol" === lA(Symbol.iterator) ? function(A) {
			...
			return A && "function" == typeof Symbol && A.constructor === Symbol && A !== Symbol.prototype ? "symbol" : void 0 ===
				A ? "undefined" : lA(A)
		},
		cA = window.device,
		dA = {},
	...
	var pA = window.document.documentElement,
		...
		yA = ["googletv", "viera", "smarttv", "internet.tv", "netcast", "nettv", "appletv", "boxee", "kylo", "roku",
	...
	function MA() {
		dA.landscape() ? (vA("portrait"), fA("landscape"), xA("landscape")) : (vA("landscape"), fA("portrait"), xA(
			"portrait")), wA()
	}
	...
	dA.macos = function() {
			...
			return dA.androidPhone() || dA.iphone() || dA.ipod() || dA.windowsPhone() || dA.blackberryPhone() || dA.fxosPhone() ||
				dA.meego()
		}, dA.tablet = function() {
			...
			return screen.orientation && Object.prototype.hasOwnProperty.call(window, "onorientationchange") ? screen.orientation
				.type.includes("portrait") : window.innerHeight / window.innerWidth > 1
		}, dA.landscape = function() {
			return screen.orientation && Object.prototype.hasOwnProperty.call(window, "onorientationchange") ? screen.orientation
				.type.includes("landscape") : window.innerHeight / window.innerWidth < 1
		}, dA.noConflict = function() {
			return window.device = cA, this
		}, dA.ios() ? dA.ipad() ? fA("ios ipad tablet") : dA.iphone() ? fA("ios iphone mobile") : dA.ipod() && fA(
			"ios ipod mobile") : dA.macos() ? fA("macos desktop") : dA.android() ? dA.androidTablet() ? fA("android tablet") :
		fA("android mobile") : dA.blackberry() ? dA.blackberryTablet() ? fA("blackberry tablet") : fA("blackberry mobile") :
		dA.windows() ? dA.windowsTablet() ? fA("windows tablet") : dA.windowsPhone() ? fA("windows mobile") : fA(
			"windows desktop") : dA.fxos() ? dA.fxosTablet() ? fA("fxos tablet") : fA("fxos mobile") : dA.meego() ? fA(
			"meego mobile") : dA.nodeWebkit() ? fA("node-webkit") : dA.television() ? fA("television") : dA.desktop() && fA(
			"desktop"), dA.cordova() && fA("cordova"), dA.onChangeOrientation = function(A) {
	...
	Object.prototype.hasOwnProperty.call(window, "onorientationchange") && (bA = "orientationchange"), window.addEventListener ?
		window.addEventListener(bA, MA, !1) : window.attachEvent ? window.attachEvent(bA, MA) : window[bA] = MA, MA(), dA.type =
		NA(["mobile", "tablet", "desktop"]), dA.os = NA(["ios", "iphone", "ipad", "ipod", "android", "blackberry",
	...
	var EA = function() {
			function A(t, e, n) {
				...
				DA(this, A), this.adVideoSource = t, this.adLink = e, this.html = c(oA.a), this.adInterval = null, this.adCloseFunction =
					n, this.html.querySelector(".video-ad-close-text").innerText = i, this.adDuration = null, this.player = null
			}
			return TA(A, [{
				key: "createEl",
				value: function(A, t) {
					var e = this,
						n = t._options && t._options.language;
					this.isEn = n && "en-us" === n, this.html.querySelector(".video-ad-detail").innerText = this.isEn ?
						"For more information" : "查看广告详情", this.html.querySelector(".limit").innerText = this.isEn ?
						"Your browser limits autoplay" : "您的浏览器限制", this.html.querySelector(".manual").innerText = this.isEn ?
						"Please Click" : "自动播放请点击";
					...
					this.html.querySelector(".icon-player-play").onclick = function() {
						...
						i.removeEventListener("canplay", A), document.getElementById("loadflag").style.display = "none", o.adDuration =
							Math.ceil(i.duration), o.html.querySelector("#video-ad-duration").innerText = o.adDuration, i.play().then(
								function() {
									o.setAdInterval()
								}).catch(function(A) {
				...
				value: function(A, t) {
					var e = this;
					null !== this.html && (A.pause(), this.player = A, this.html.querySelector(".video-ad-close label").onclick =
						function() {
							"function" == typeof e.adCloseFunction ? e.adCloseFunction(e) : e.closeVideoAd(), document.getElementById(
								"player-con").getElementsByTagName("video")[0].play()
						})
				}
			}, {
				key: "pauseVideoAd",
				...
				value: function() {
					...
					this.adInterval = setInterval(function() {
						A.adDuration -= 1, A.adDuration <= 0 ? (A.closeVideoAd(), document.getElementById("player-con").getElementsByTagName(
							"video")[0].play()) : t.innerText = A.adDuration
					}, 1e3)
				}
			}, {
				key: "closeVideoAd",
				value: function() {
					this.clearAdInterval(), this.html.parentNode.removeChild(this.html), this.html = null, this.player.getOptions()
		...
		QA = function() {
			function A(t, e, n) {
				var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "关闭广告";
				DA(this, A), this.adVideoSource = t, this.adLink = e, this.html = c(aA.a), this.adInterval = null, this.adCloseFunction =
					n, this.html.querySelector(".video-ad-close-text").innerText = i, this.html.querySelector(".video-ad-link").setAttribute(
						"href", this.adLink), this.html.querySelector(".video-ad-detail").setAttribute("href", this.adLink), this.adDuration =
					null
			}
			return TA(A, [{
				key: "createEl",
				value: function(A, t) {
					var e = t._options && t._options.language;
					this.isEn = e && "en-us" === e, this.html.querySelector(".video-ad-detail").innerText = this.isEn ?
						"For more information" : "查看广告详情", this.html.querySelector(".limit").innerText = this.isEn ?
						"Your browser limits autoplay" : "您的浏览器限制", this.html.querySelector(".manual").innerText = this.isEn ?
						"Please Click" : "自动播放请点击", A.appendChild(this.html), A.querySelector("video"), A.querySelector("video").setAttribute(
							"preload", "load");
				...
				value: function(A) {
					var t = this;
					if (this.player = A, this.vdSource = A.getOptions().source, A.loadByUrl(this.adVideoSource), this.html.querySelector(
							".autoplay-video-ad").onclick = function() {
							null !== t.adDuration && (A.loadByUrl(t.adVideoSource), t.html.parentNode.querySelector(
						...
						e.addEventListener("timeupdate", function t() {
							...
							isNaN(i) || 0 === i || (e.removeEventListener("timeupdate", t), n.adDuration = Math.ceil(e.duration),
								"none" !== n.html.querySelector(".autoplay-video-ad").style.display && (n.html.querySelector(
									".autoplay-video-ad").style.display = "none", A.play()), n.html.querySelector("#video-ad-duration").innerText =
								n.adDuration, n.setAdInterval())
						})
					}
				}
			}, {
				...
				value: function(A) {
					...
					this.html.querySelector(".video-ad-close label").onclick = function() {
						"function" == typeof t.adCloseFunction ? t.adCloseFunction(t) : t.closeVideoAd(), document.getElementById(
							"player-con").getElementsByTagName("video")[0].play()
					}
				}
			}, {
				...
				value: function() {
					...
					t.className = t.className.replace(" controlbar-element-hidden", ""), this.player.getOptions().autoplay &&
						this.player.play(), this.html.parentNode.removeChild(this.html)
				}
			}, {
				key: "clearAdInterval",
				value: function() {
		...
		OA = function() {
			...
			return zA(A, [{
				...
				value: function(A, t) {
					var e = this,
						n = t._options && t._options.language;
					this.isEn = n && "en-us" === n, this.modalHtml.querySelector(".switchimg").innerText = this.isEn ?
						"Switching to you for" : "字幕切换到", this.modalHtml.querySelector(".switchimg").style.display = "none", A.querySelector(
							".prism-controlbar").appendChild(this.html), A.appendChild(this.modalHtml), t.on("textTrackReady",
							function(A) {
								var t = A.paramData;
								e.captionList = t;
					...
					0 == this.hasCreated && this.definition && (o.querySelector('li[data-def="' + this.definition + '"]').className =
						"current"), this.hasCreated = !0;
					var r = null;
					i.onclick = function() {
						...
						if (i && "current" !== n.className) {
							...
							t._ccService.switch(o.value), e.setCurrentCaption(o.text, o.value), e.modalHtml.style.display = "block",
								e.modalHtml.querySelector(".switchimg").style.display = "block", e.modalHtml.querySelector(
									"span.current-caption-tag").innerText = o.text
						}
					}
				}
			}, {
			...
			return HA(A, [{
				...
				value: function(A, t) {
					var e = this,
						n = t._options && t._options.language;
					this.isEn = n && "en-us" === n, this.modalHtml.querySelector(".switchimg").innerText = this.isEn ?
						"Track to you for" : "音轨切换到", this.modalHtml.querySelector(".switchimg").style.display = "none", A.querySelector(
							".prism-controlbar").appendChild(this.html), A.appendChild(this.modalHtml), t.on("audioTrackReady",
							function(A) {
								var t = A.paramData;
								e.trackList = t;
								var n = t.map(function(A) {
					...
					i.onclick = function() {
						...
						if (i && "current" !== n.className) {
							...
							t._audioTrackService.switch(o.value), e.setCurrentTrack(o.text, o.value), e.modalHtml.style.display =
								"block", e.modalHtml.querySelector(".switchimg").style.display = "block", e.modalHtml.querySelector(
									"span.current-track-tag").innerText = o.text
						}
					}
				}
			}, {
	...
	var KA = function() {
			function A(t, e) {
				...
				WA(this, A), this.adVideoSource = t, this.html = c(qA.a), this.adInterval = null, this.adCloseFunction = e, this.html
					.querySelector(".many-video-ad-close-text").innerText = n, this.adDuration = null, this.player = null, this.indexVideo =
					1
			}
			return JA(A, [{
				key: "createEl",
				value: function(A, t) {
					var e = t._options && t._options.language;
					this.isEn = e && "en-us" === e, this.html.querySelector(".many-video-ad-detail").innerText = this.isEn ?
						"For more information" : "查看广告详情", this.html.querySelector(".limit").innerText = this.isEn ?
						"Your browser limits autoplay" : "您的浏览器限制", this.html.querySelector(".manual").innerText = this.isEn ?
						"Please Click" : "自动播放请点击", A.appendChild(this.html)
				}
			}, {
				key: "created",
				value: function(A) {
					var t = this.adVideoSource.map(function(A, t) {
						return '<video id="many-video-ad-content' + (t + 1) + '" style="' + (0 === t ? "display: block" :
								"display:none") +
							';width:100%;height:100%" x5-video-player-type="h5" x5-video-player-fullscreen="false" src="' + A.adVideo +
							'"></video>'
					});
					...
					void 0 !== l && l.then(function() {
						...
						i.removeEventListener("canplay", A), o.href = n[e - 1].adVideoLink, i.play().then(function() {
							...
							a.html.querySelector(".autoplay-many-video-ad").style.display = "block", a.html.querySelector(
								".icon-player-play").onclick = function() {
				...
				value: function(A) {
					...
					this.indexVideo = Number(this.indexVideo), null != document.getElementById("many-video-ad-content" + this.indexVideo) &&
					...
					e.style.display = "block", this.adVideoSource.length >= this.indexVideo && (this.indexVideo = this.indexVideo +
						1);
				...
				value: function() {
					this.clearAdInterval(), this.html.parentNode.removeChild(this.html), this.html = null, document.getElementById(
						"player-con").getElementsByTagName("video")[0].play()
				}
			}]), A
		}(),
		XA = function() {
			function A(t, e) {
				var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "关闭广告";
				WA(this, A), this.adVideoSource = t, this.html = c(RA.a), this.adInterval = null, this.adCloseFunction = e, this.html
					.querySelector(".many-video-ad-close-text").innerText = n, this.adDuration = null, this.player = null, this.indexVideo =
					1
			}
			return JA(A, [{
				...
				value: function(A, t) {
					var e = this,
						n = t._options && t._options.language;
					this.isEn = n && "en-us" === n, this.html.querySelector(".many-video-ad-detail").innerText = this.isEn ?
						"For more information" : "查看广告详情", this.html.querySelector(".limit").innerText = this.isEn ?
						"Your browser limits autoplay" : "您的浏览器限制", this.html.querySelector(".manual").innerText = this.isEn ?
						"Please Click" : "自动播放请点击", A.appendChild(this.html), A.querySelector(".videosmb"), A.querySelector(
							".videosmb").setAttribute("preload", "load");
					var i = A.querySelector(".prism-controlbar");
					i.className = i.className + " controlbar-element-hidden", this.html.querySelector(".icon-player-play").onclick =
						function() {
				...
				value: function(A) {
					...
					var e = this.indexVideo,
						...
						r = this;
					i.addEventListener("canplay", function A() {
						i.removeEventListener("canplay", A), o.href = n[e - 1].adVideoLink, r.html.querySelector(
							"#many-video-ad-duration").innerText = Math.ceil(i.duration)
					})
				}
			}, {
				key: "ready",
				...
				value: function() {
					...
					var A = this.html.parentNode.querySelector(".prism-controlbar");
					A.className = A.className.replace(" controlbar-element-hidden", ""), this.html.parentNode.removeChild(this.html),
						this.html = null, document.getElementById("player-con").getElementsByTagName("video")[0].play()
				}
			}, {
				key: "clearAdInterval",
				value: function() {
