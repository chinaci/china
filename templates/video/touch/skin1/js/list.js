...
var nav_id = decodeURI(getUrlParam('id'));//各个type分类
var orby = decodeURI(getUrlParam('orderby'));//最新最热
var flagr = decodeURI(getUrlParam('flag'));
...
function getList(title){
  ...
  $.ajax({
      url : '/include/ajax.php?service=video&action=alist',
      data : data.join('&'),
      type : 'get',
      dataType : 'json',
