								...
								if(list.length > 0){
									for(var i = 0; i < list.length; i++){
										if(i==0 && atpage==1){
											...
											ggoodboxhtml.push('<a href="'+list[i].url+'" class="fn-clear"><p class="ptitle"><img src="'+templets_skin+'images/bqhh.png" alt=""></p>');
											ggoodboxhtml.push('<div class="main_box fn-clear">');
											ggoodboxhtml.push('<div class="imgbox"><img src="'+list[i].litpic+'" alt=""></div>');
											...
											ggoodboxhtml.push('<div class="pricebox"><span class="nprice"><em>'+echoCurrency('symbol')+'</em>'+list[i].price+'</span><span class="yprice">'+echoCurrency('symbol')+''+list[i].mprice+'</span><span class="gobuying">'+textName+'</span></div>');
											ggoodboxhtml.push('</div>');
											ggoodboxhtml.push('</div></a>');
											ggoodboxhtml.push('</div>');
										}else if(i>=1 && i<4 && atpage==1){
											 likeboxhtml.push('<li>');
											 likeboxhtml.push('<a href="'+list[i].url+'" class="fn-clear">');
											 likeboxhtml.push('<div class="imgbox">');
					                         likeboxhtml.push('<img src="'+list[i].litpic+'" alt="">');
