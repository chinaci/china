							...
							success: function (data) {
								if(data && data.state == 100){
									...
									for(var i = 0; i < addList.length; i++){
										...
										list.push('<a src="javascript:;" data-id="'+addList[i].id+'" data-name="'+addList[i].person+'" data-tel="'+contact+'" data-tel="'+addList[i].tel+'" data-addr="'+addList[i].addrname+'&nbsp;&nbsp;'+addList[i].address+'" data-code="'+addList[i].areaCode+'">');
										var areaCode = addList[i].areaCode;
					                    var code = '';
					                    if(areaCode != '' && areaCode != '86'){
					                      code = "+"+areaCode;
					                    }
					                    list.push('<p><span>'+addList[i].person+'</span><span>电话：'+code+' '+contact+'</span></p>');
