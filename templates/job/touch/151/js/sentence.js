          ...
          if(data){
            if(data.state == 100){
              ...
              if(list.length > 0){
                for(var i = 0; i < list.length; i++){
                  var ar = '',ar2 = '';
                  if(list[i].areaCode!='86' && list[i].areaCode!=''){
                    ar = list[i].areaCode
                    ar2 = '+'+list[i].areaCode+' '
                  }
                  html.push('<li>');
                  ...
                  if(userid == null || userid == ""){
                    ...
                    html.push('<div class="list_info fn-clear"><span class="info_name">'+list[i].people+'</span><span class="info_phone"><a href="tel:'+ar+list[i].contact+'">'+ar2+list[i].contact+'</a></span><span class="info_t">'+list[i].pubdate+'</span></div>');
                  }
                ...
                if(data.state == 100 && data.info == 'success'){
                    ...
                    $.ajax({
                        ...
                        success:function (data) {
                            ...
                            $("input[name=item4]").attr('value', data_info.password);
                            $("#areaCode").attr('value', data_info.areaCode);
                            console.log(data_info.areaCode);
                            if(data_info.areaCode == '86' || data_info.areaCode == ''){
                              $('.modify .info .areacode_span').hide();
                              $('.modify .info input#spe_input').css({'width':'4.2rem','padding-left':'0'})
                            }else{
                              $(".modify .info .areacode_span em").text('+'+data_info.areaCode);
                              
                              $('.modify .info .areacode_span').show();
                              $('.modify .info input#spe_input').css({'width':'2.8rem','padding-left':'.1rem'})
                            }
