...
//                  默认图标 加class名  default_chose
                  addrList.push('<li class="address_li fn-clear " data-areacode="'+addr.areaCode+'" data-id="'+addr.id+'" data-people="'+addr.person+'" data-contact="'+addr.tel+'" data-lng="'+addr.lng+'" data-lat="'+addr.lat+'" data-street="'+addr.street+'" data-address="'+addr.address+'" data-juli ="'+addr.juli+'">');
                  addrList.push('<div class="chose_txt"><h3>'+addr.person+' <em>'+(addr.areaCode != '' && addr.areaCode != '86' ? '+' + addr.areaCode + addr.tel : addr.tel)+'</em></h3>');
