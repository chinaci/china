...
function calculatedAdvSize(obj){
  ...
  if(!obj.parent().height()){
    obj.css({'min-height': '100px'});
  };
  if(obj.size() > 0){
    obj.find('h6').html('尺寸【'+obj.width()+' × '+obj.height()+'】px');
  }
}
