...
!function( $ ) {
	...
	function UTCToday(){
		var today = new Date();
		return UTCDate(today.getUTCFullYear(), today.getUTCMonth(), today.getUTCDate(), today.getUTCHours(), today.getUTCMinutes(), '0', 0);
	}
				...
				switch(target[0].nodeName.toLowerCase()) {
					case 'th':
						switch(target[0].className) {
							...
							case 'today':
								var date = new Date();
								date = UTCDate(date.getFullYear(), date.getMonth(), date.getDate(), date.getHours(), date.getMinutes(), '0', 0);
	...
	var DPGlobal = {
		...
		parseDate: function(date, format, language, type) {
			...
			if (/^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(date)) {
				...
				return UTCDate(date.getUTCFullYear(), date.getUTCMonth(), date.getUTCDate(), date.getUTCHours(), date.getUTCMinutes(), '0', 0);
			}
			var parts = date && date.match(this.nonpunctuation) || [],
				...
				setters_map = {
					...
					ss: function(d,v){ return '0'; },
					s:  function(d,v){ return '0'; },
			...
			date = UTCDate(date.getFullYear(), date.getMonth(), date.getDate(), date.getHours(), date.getMinutes(), '0');
