;(function ( $, window, document, undefined ) {
    ...
    var htmlGeneralPanel = ['<div class="huoniao_color_general" style="display:none"><div class="color_general">', htmlGen, '</div><div class="color_list">', htmlList, '</div><div class="color_standard">', htmlStandard, '</div><div class="set_general"><a href="javascript:;" class="J_set_general" title="点击打开高级颜色选择面板">高级颜色</a><a class="J_default_color no_color" href="javascript:;">恢复默认</a></div></div>'].join('');

    var htmlSeniorPanel = '<div class="huoniao_color_senior" style="display:none">\
    ...
    Plugin.prototype.init = function () {
		...
		container.find('.huoniao_color_general').show();
		//事件触发时显示取色器
        ...
        var positionElement = function() {
            var position = 'absolute',
                ...
                top = follow_elem_offset.top;
                left = follow_elem_offset.left;
            container.css( {position:position, zIndex:zIndex, left:left + 'px', top:top+follow_elem_height + 'px'} );
        }
		...
		//add Event
		container.find('.huoniao_color_general').on('click','strong',function(e) {
		...
		//色块鼠标指示
		container.find('.huoniao_color_general').on('mouseenter','strong',function(e) {
		...
		container.find('.J_set_general').on('click',function(e) {
            e.preventDefault();
			$('.huoniao_color_general').hide();
			$('.huoniao_color_senior').show();
		});

		//点击切换到普通模式
		container.find('.J_set_senior').on('click',function(e) {
            e.preventDefault();
			$('.huoniao_color_senior').hide();
			$('.huoniao_color_general').show();
		});
