		...
		$(this).each(function() {
			this.oncontextmenu = function(e) {
				...
				if (jqueryMenu) {
					...
					if(top + jqueryMenu.height() > document.documentElement.clientHeight){
						top = top - jqueryMenu.height();
					}
					if(e.clientX + params.offsetX + jqueryMenu.width() > document.documentElement.clientWidth){
						left = left - jqueryMenu.width();
					}
					jqueryMenu.css({
						display: "block",
						left: left,
