	...
	huoniao.operaJson("communityList.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < communityList.length; i++){
				...
				list.push('  <td class="row35 left">'+img+'<span><code style="margin-right: 3px;">ID:'+communityList[i].id+'</code><a href="'+communityList[i].url+'" target="_blank">'+communityList[i].title+'</a><br /><small style="display: inline; color: #666;">'+communityList[i].date+'</small></span></td>');
