$(function(){
	...
	$("#addNew").bind("click", function(event){
		...
		try {
			event.preventDefault();
			parent.addPage("add"+module+"Mytag", "video", "生成新标签", "video/"+href);
		} catch(e) {}
	});
	...
	$("#addNewTemp").bind("click", function(event){
		...
		try {
			event.preventDefault();
			parent.addPage("mytagTemp"+module, "video", "标签模板", "video/"+href);
		} catch(e) {}
	});
	...
	$("#list").delegate(".edit", "click", function(event){
		...
		try {
			event.preventDefault();
			parent.addPage("edit"+module+"Mytag"+id, "video", title, "video/"+href);
		} catch(e) {}
	});
