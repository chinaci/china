$(function(){
	...
	$("#addNew").bind("click", function(event){
		...
		try {
			event.preventDefault();
			parent.addPage("add"+module+"Mytag", "image", "生成新标签", "image/"+href);
		} catch(e) {}
	});
	...
	$("#addNewTemp").bind("click", function(event){
		...
		try {
			event.preventDefault();
			parent.addPage("mytagTemp"+module, "image", "标签模板", "image/"+href);
		} catch(e) {}
	});
	...
	$("#list").delegate(".edit", "click", function(event){
		...
		try {
			event.preventDefault();
			parent.addPage("edit"+module+"Mytag"+id, "image", title, "image/"+href);
		} catch(e) {}
	});
