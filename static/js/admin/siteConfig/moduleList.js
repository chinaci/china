					...
					if(jsonArray["parentid"] == 0){
						...
						if(jsonArray["type"] == 0){
							if(jsonArray['name'] == defaultindex){
								typeList.push('<a href="javascript:;" class="index curr"><s class="check checked"></s><br/>设为首页</a>&nbsp;&nbsp;&nbsp;&nbsp;');
							}else{
								typeList.push('<a href="javascript:;" class="index"><s class="check"></s><br/>设为首页</a>&nbsp;&nbsp;&nbsp;&nbsp;');
							}
						}else{
							typeList.push('<a href="javascript:;" class="index" style="visibility: hidden;"><s class="check"></s><br/>设为首页</a>&nbsp;&nbsp;&nbsp;&nbsp;');
						}
						...
						if(jsonArray['name'] != 'special' && jsonArray['name'] != 'website'){
							if(jsonArray['app'] == 0){
								typeList.push('<a href="javascript:;" class="app curr"><s class="check checked"></s><br/>APP</a>&nbsp;&nbsp;&nbsp;&nbsp;');
							}else{
								typeList.push('<a href="javascript:;" class="app"><s class="check"></s><br/>APP</a>&nbsp;&nbsp;&nbsp;&nbsp;');
							}
						}
