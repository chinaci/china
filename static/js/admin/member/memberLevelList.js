$(function(){
	...
	$("#addNew").bind("click", function(){
		...
		html.push('	 <div class="row60 left"><a href="javascript:;" class="upfile" title="上传图标">上传图标</a><input type="file" name="Filedata" value="" class="imglist-hidden Filedata hide" id="Filedata_'+len+'"><input type="hidden" name="icon" class="icon" value=""></div>')
